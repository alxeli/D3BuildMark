<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/BaseTemplate.Master" AutoEventWireup="true" CodeBehind="BuildCompareView.aspx.cs" Inherits="D3BuildMarkSite.BuildCompareView" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cContent" runat="server">
    <uc1:uxBuildSnapshotView runat="server" id="uxBuildSnapshotView1" />
    <uc1:ViewBuildSnapshotAlt runat="server" ID="ViewBuildSnapshotAlt" />
</asp:Content>
