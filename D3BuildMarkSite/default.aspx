<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/BaseTemplate.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="D3BuildMarkSite._default" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cContent" runat="server">
    ...
    <asp:Button ID="uxViewBuildSnapshot" OnClick="uxViewBuildSnapshot_Click" runat="server" />
</asp:Content>
